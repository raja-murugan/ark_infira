									...
									<div class="expand-btn-inner">
										<ul>
											<li class="btn-quote"><a class="quote-button"
													...
													target="_blank">Chat on Whatsapp</a></li>
											<li class="humburger">
			...
			<div class="rs-breadcrumbs img1">
				<div class="container">
					<div class="breadcrumbs-inner">
						...
						<span class="sub-text">We are your go-to source for all your building
							needs thanks to our more than 5 years of experience in the field.</span>
					...
					<div class="row y-middle">
						<div class="col-lg-6 pr-60 md-pr-15 mt-40 md-mb-40">
							...
							<div class="cl-skill-bar">
								<!-- Start Skill Bar -->
								<span class="skillbar-title">Planning & Designing</span>
								<div class="skillbar" data-percent="100">
									<p class="skillbar-bar"></p>
									<span class="skill-bar-percent"></span>
								</div>
								<!-- Start Skill Bar -->
								<span class="skillbar-title">Sanctioning</span>
								<div class="skillbar" data-percent="100">
									<p class="skillbar-bar"></p>
									<span class="skill-bar-percent"></span>
								</div>
								<!-- Start Skill Bar -->
								<span class="skillbar-title">Estimation</span>
								<div class="skillbar" data-percent="100">
									<p class="skillbar-bar"></p>
									<span class="skill-bar-percent"></span>
								</div>
								<!-- Start Skill Bar -->
								<span class="skillbar-title">Supervision</span>
								<div class="skillbar" data-percent="100">
									<p class="skillbar-bar"></p>
									<span class="skill-bar-percent"></span>
								</div>
								<!-- Start Skill Bar -->
								<span class="skillbar-title">3D Elevation</span>
								<div class="skillbar" data-percent="100">
									<p class="skillbar-bar"></p>
									<span class="skill-bar-percent"></span>
								</div>
					...
					<div class="row">
						<div class="col-lg-3 pr-20 md-pr-15 md-mb-20">
							<div class="footer-logo mb-10 md-mb-30">
								<a href="index.php"><img src="assets/image/logo/logo.png" alt=""
