...
<html lang="zxx">
	...
	<body class="defult-home">
		...
		<div class="main-content">
			...
			<div class="rs-breadcrumbs img2">
			    <div class="container">
			        <div class="breadcrumbs-inner">
			            ...
			            <span class="sub-text">With more than 5 years of experience in the construction industry, we are your trusted source for all your construction needs.
						</span>
					...
					<div class="row">
						<div class="col-xl-4 col-md-6 mb-20">
							<div class="services-item">
								...
								<div class="services-icon">
									<img src="assets/image/services/6.png" alt="Images">
								</div>
								<div class="services-text">
									<h4 class="title"><a href="s-planning-designing.php">Planning & Desiging</a></h4>
									<p class="services-txt">We take the hassle out of planning and designing, working with you every step of the way.</p>
								</div>
							</div>
						</div>
						<div class="col-xl-4 col-md-6 mb-20">
							<div class="services-item">
								...
								<div class="services-icon">
									<img src="assets/image/services/1.png" alt="Images">
								</div>
								<div class="services-text">
									<h4 class="title"><a href="s-sanctioning.php">Sanctioning</a></h4>
									<p class="services-txt">We want to free up your time so you may more easily concentrate on the task at hand. </p>
								</div>
							</div>
						</div>
						<div class="col-xl-4 col-md-6 mb-20">
							<div class="services-item">
								...
								<div class="services-icon">
									<img src="assets/image/services/2.png" alt="Images">
								</div>
								<div class="services-text">
									<h4 class="title"><a href="s-estimation.php">Estimation</a></h4>
									<p class="services-txt">Utilize our extensive experience and our reliable estimation service to plan your projects.</p>
								</div>
							</div>
						</div>
						<div class="col-xl-4 col-md-6 md-mb-20">
							<div class="services-item">
								...
								<div class="services-icon">
									<img src="assets/image/services/3.png" alt="Images">
								</div>
								<div class="services-text">
									<h4 class="title"><a href="s-supervision.php">Supervision</a></h4>
									<p class="services-txt">Experience professional streamlined supervision services for your project with ark today.</p>
								</div>
							</div>
						</div>
						<div class="col-xl-4 col-md-6 sm-mb-20">
							<div class="services-item">
								...
								<div class="services-icon">
									<img src="assets/image/services/4.png" alt="Images">
								</div>
								<div class="services-text">
									<h4 class="title"><a href="s-3d-elevation.php">3D Elevation</a></h4>
									<p class="services-txt">Get extremely realistic 3D Elevation design, for real-time experience of your project.</p>
								</div>
							</div>
						</div>
						<div class="col-xl-4 col-md-6">
							<div class="services-item">
								...
								<div class="services-icon">
									<img src="assets/image/services/5.png" alt="Images">
								</div>
								<div class="services-text">
									<h4 class="title"><a href="s-construction.php">Construction</a></h4>
									<p class="services-txt">From budgeting to planning, from design to implementation we are there for you.</p>
								</div>
							</div>
						</div>
					</div>
					...
					<div class="row">
						...
						<div class="col-lg-4 text-right md-left md-mb-40">
							<div class="btn-part mt-20">
								<a class="readon more touch" href="contact.php">Get In Touch</a>
							</div>
						</div>
					</div>
				</div>
						...
						<div class="row">
							<div class="col-xl-3 col-md-6 md-40">
								<div class="process-item process-gap">
									<div class="number-image">
										<img src="assets/image/services/p1.png" alt="Images">
									</div>
									<div class="number-text">
	                                    ...
	                                    <p class="number-txt">Begins with Planning project based on your budget & Time.</p>
	                                </div>
								</div>
							</div>
							<div class="col-xl-3 col-md-6 md-40">
								<div class="process-item process-gap">
									<div class="number-image">
										<img src="assets/image/services/p2.png" alt="Images">
									</div>
									<div class="number-text">
										<div class="number-area">
	                                    ...
	                                    <p class="number-txt">After starting the process of creating the action plan.</p>
	                                </div>
								</div>
							</div>
							<div class="col-xl-3 col-md-6 sm-mb-40">
								<div class="process-item">
									<div class="number-image">
										<img src="assets/image/services/p3.png" alt="Images">
									</div>
									<div class="number-text">
										<div class="number-area">
	                                    ...
	                                    <p class="number-txt">Putting the strategy into action with qualified engineers.</p>
	                                </div>
								</div>
							</div>
							<div class="col-xl-3 col-md-6">
								<div class="process-item">
									<div class="number-image">
										<img src="assets/image/services/p4.png" alt="Images">
									</div>
									<div class="number-text">
										<div class="number-area">
	                                    ...
	                                    <p class="number-txt">Complete and delivering the project of your dreams on time.</p>
	                                </div>
								</div>
							</div>
						</div>
			...
			<div class="rs-cta pt-120 pb-115 md-pt-80 md-pb-75">
				<div class="container">
