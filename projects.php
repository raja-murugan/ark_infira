		...
		<div class="rs-breadcrumbs img3">
			<div class="container">
				<div class="breadcrumbs-inner">
					...
					<span class="sub-text">We are your trusted source for all your construction needs, with over 5 years
						of experience in the field. Below are some of our most recent and successful projects.</span>
			...
			<div class="container">
				<div class="row">
					<div class="col-lg-4 col-md-6 mb-30">
						<div class="project-item" style="height: 370px;">
							<div class="project-img">
								<img src="assets/image/projects/project-2.jpeg" alt="images" style="height: 370px;">
							</div>
							<div class="project-content">

								<div class="project-inner">
									<span class="category"><a href="#">Priya's Villa</a></span>
									<h3 class="title"><a href="#">Pandamangalam, Trichy.</a></h3>
								</div>
							</div>
						</div>
					</div>
					<div class="col-lg-4 col-md-6 mb-30">
						<div class="project-item" style="height: 370px;">
							<div class="project-img">
								<img src="assets/image/projects/project-1.jpeg" alt="images">
							</div>
							<div class="project-content">

								<div class="project-inner">
									<span class="category"><a href="#">Johnson's Villa</a></span>
									<h3 class="title"><a href="#">Kattur, Trichy.</a></h3>
								</div>
							</div>
						</div>
					</div>
						...
						<div class="project-item">
							...
							<div class="project-content">
								...
								<div class="project-inner">
									...
									<h3 class="title"><a href="#">Trichy</a></h3>
								</div>
							</div>
						</div>
					</div>
				...
				<div class="row">
					<div class="col-lg-3 pr-20 md-pr-15 md-mb-20">
						...
						<div class="textwidget">
							<p class="pb-20">Partnering with us means taking your construction goals to the next level
								with expert advice and reliable Company. </p>
					...
					<div class="col-lg-3 md-mb-10">
						...
						<ul class="address-widget">
							<li>
								<i class="fi fi-rr-map-marker-home"></i>
								<div class="desc">
									1st Floor, Mumtaz Complex, Opp to Monfort School, St. Raj Nagar, Kattur, Trichy -
									19.
								</div>
							</li>
							<li>
				...
				<div class="row y-middle">
					<div class="col-lg-6 md-mb-10 text-lg-end text-center order-last">
						<div class="copyright text-center">
							<p>Designed & Developed By <a href="https://www.zworktechnology.com/" target="blank">Zwork
									Technology</a></p>
						</div>
					</div>
					<div class="col-lg-6">
