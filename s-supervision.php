                    ...
                    <div class="row">
                        <div class="col-lg-8 md-mb-50">
                            <div class="services-img mb-35">
                                <img
                                    src="assets/image/services/s-b-5.jpg"
                                    alt="">
                            </div>
                            <div class="services-title pb-24">
                                <h2 class="title">Supervision</h2>
                            </div>
                            <p class="desc-part pb-24">We at Ark Infra
                                Constructions are aware of how crucial oversight
                                is to civil projects. We offer thorough and
                                dependable supervision services for all civil
                                project types, including residential,
                                commercial, and industrial projects. Our skilled
                                staff is trained to make sure that all projects
                                are finished on time, within budget, and to the
                                highest standards possible. We can assure you
                                that your project will be finished with the
                                highest level of correctness and efficiency
                                thanks to our in-depth knowledge and experience
                                in the industry. We monitor development and make
                                sure that all safety rules are followed using
                                cutting-edge technology. You can rely on us to
                                achieve the greatest outcomes for your project
                                because to our commitment to offering top-notch
                                customer service.</p>
                            <ul class="check-lists3">
                                <li>Constant supervision by qualified professionals</li>
                                <li>Building, industrial, and infrastructure project management consultant</li>
                                <li>Site supervision in compliance with technical and construction legislative criteria</li>
                                <li>Infrastructure and building maintenance and facility management oversight</li>
                            </ul>
                        </div>
                        <div class="col-lg-4 pl-36 md-pl-15">
                            <ul class="services-list mb-50">
                                ...
                                <li><a class="active" href="s-supervision.php">Supervision</a></li>
                    ...
                    <div class="call-action">
                        <div class="sec-title text-center">
                            <span class="sub-text yellow-color">
                                <img src="assets/image/shape-1.png"
                                    alt="Images">
                    ...
                    <div class="row">
                        <div class="col-lg-3 pr-20 md-pr-15 md-mb-20">
                            ...
                            <div class="textwidget">
                                ...
                                <p class="pb-25"><strong>Opening Hours</strong>
                                    : Monday – Sat : 10 am to 7 pm</p>
                            </div>
                            ...
                            <ul class="address-widget">
                                ...
                                <li>
                                    ...
                                    <div class="desc">
                                        <a href="tel:+919894443932">+91 98944
                                            43932</a><br>
                                        <a href="tel:+919092759389">(+880)155
                                            69569 366</a>
                                    </div>
                                </li>
                                <li>
                                    ...
                                    <div class="desc">
                                        <a
                                            href="mailto:arkinfra.india@gmail.com">arkinfra.india@gmail.com</a><br>
                                        <a
                                            href="mailto:info@arkinfraindia.com">info@arkinfraindia.com</a>
                                    </div>
                                </li>
                            </ul>
                        </div>
            ...
            <div class="footer-bottom">
                <div class="container">
                    <div class="row y-middle">
                        <div class="col-lg-6 md-mb-10 text-lg-end text-center
                            order-last">
