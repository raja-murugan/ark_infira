                    ...
                    <div class="row">
                        <div class="col-lg-8 md-mb-50">
                            <div class="services-img mb-35">
                                <img
                                    src="assets/image/services/s-b-2.jpg"
                                    alt="">
                            </div>
                            <div class="services-title pb-24">
                                <h2 class="title">Construction</h2>
                            </div>
                            <p class="desc-part pb-24">For all of your civil projects, we at Ark Infra Constructions are dedicated to you the best construction service. We are aware that construction projects demand accuracy and close attention to detail. We are experts in a range of civil projects, including infrastructure, commercial structures, and home development. Our staff has the skills and expertise required to guarantee that your project is finished on schedule and on budget. We aim for quality in all we do, from offering thorough project estimates to making sure that all safety guidelines are followed while building is underway. You can be certain that you're getting the best construction services possible when you work with Civil Project Construction.</p>
                            <ul class="check-lists3">
                                <li>Engineers with the most experience</li>
                                <li>Expert Work with a Wide Range of Experience</li>
                        ...
                        <div class="col-lg-4 pl-36 md-pl-15">
                            <ul class="services-list mb-50">
                                ...
                                <li><a class="active" href="s-construction.php">Construction</a></li>
                            </ul>
