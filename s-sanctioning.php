                    ...
                    <div class="row">
                        <div class="col-lg-8 md-mb-50">
                            <div class="services-img mb-35">
                                <img
                                    src="assets/image/services/s-b-4.jpg"
                                    alt="">
                            </div>
                            <div class="services-title pb-24">
                                <h2 class="title">Sanctioning</h2>
                            </div>
                            <p class="desc-part pb-24">You can quickly and
                                simply detect any potential needs or compliance
                                issues related to your civil project with the
                                use of our user-friendly sanctioning solution.
                                With it, you can make sure that all pertinent
                                requirements are being followed without worrying
                                about how complicated the procedure is. In order
                                to get the most out of your project, our method
                                is made to provide you the finest outcomes
                                possible when it comes to sanctioning.</p>
                            <ul class="check-lists3">
                                <li>Experienced Professionals to handle
                                    Sanctioning</li>
                                <li>Maintaining Professional Approch for
                                    sanctioning service</li>
                                <li>With our method 100% Quick Project Approval
                                    Granty</li>
                            </ul>
                        </div>
