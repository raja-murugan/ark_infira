			        ...
			        <div class="row">
			            <div class="col-lg-8 md-mb-50">
			                <div class="services-img mb-35">
			                    <img src="assets/image/services/s-b-3.jpg" alt="">
			                </div>
			                <div class="services-title pb-24">
			                    <h2 class="title">Planning & Designing</h2>
			                </div>
							<p class="desc-part pb-24">As a prominent company in the civil construction sector, we offer planning and designing services. Our team of experts is committed to giving our customers the best planning and designing services possible for their building projects. We specialize in developing unique ideas and plans that satisfy the requirements and expectations of each of our clients. Our team has a wealth of industry knowledge, which enables us to offer thorough answers to any planning or designing issue.
							</p>
			                <p class="desc-part pb-24">
								We use state-of-the-art technology to develop creative solutions that conserve time, money, and resources while maintaining superior quality. We promise that your construction project will be finished with our expertise on schedule, on budget, and to your satisfaction.
			                </p>
			                <ul class="check-lists3">                              
			                    <li>Future-focused planning and design service</li>
                  			 	<li>Planning your projects with professional engineers</li>
                  			 	<li>Skilled Designers to Create Your Vision</li>          
                  			 	<li>A flexible approach to maximize the minimum budget and time</li>          
			                </ul>
			            </div>
			            <div class="col-lg-4 pl-36 md-pl-15">
			                <ul class="services-list mb-50">
			                   <li><a class="active" href="s-planning-designing.php">Planning & Designing</a></li>
